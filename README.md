...
### 3.1 Sơ đồ tuần tự chức năng đăng ký
...
### 3.2. Sơ đồ tuần tự chức năng đăng tin tuyển dụng
...
### 3.3. Sơ đồ tuần tự chức năng ứng tuyển
...
### 3.4. Sơ đồ tuần tự chức năng quản lý quy trình ứng tuyển
...
### 4.1. Sơ đồ hoạt động chức năng đăng ký
![alt text](image-1.png)

### 4.2. Sơ đồ hoạt động chức năng đăng tin
![alt text](image.png)

### 4.3. Sơ đồ hoạt động chức năng quản lý tin tuyển dụng
![alt text](image-2.png)

### 4.4. Sơ đồ hoạt động chức năng quản lý danh sách ứng viên
